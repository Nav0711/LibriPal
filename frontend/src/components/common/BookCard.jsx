...
import { Star, BookOpen, Users, Calendar, ExternalLink } from 'lucide-react';
        ...
        <div className="flex-1">
          ...
          {book.ai_summary && (
            <p className="text-gray-700 text-sm mb-2 leading-relaxed">
              {truncateText(book.ai_summary, 120)}
            </p>
          )}
          
          <div className="flex items-center gap-4 mb-3 text-xs text-gray-500">
            {book.genre && (
              <span className="genre-tag bg-blue-50 text-blue-700 px-2 py-1 rounded">
                {book.genre}
              </span>
            )}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className={`availability-badge text-xs px-2 py-1 rounded-full ${
            ...
            {showActions && (
              <button 
                ...
                onClick={() => handleAction(
                  book.available_copies > 0 ? onBorrow : onReserve, 
                  book.id
                )}
                disabled={actionLoading}
              >
