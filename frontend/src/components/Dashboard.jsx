  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const upcomingDues = borrowed.borrowed_books.filter(
          (book) => book.urgency === "due_soon" || book.urgency === "overdue",
        )
    ...
    <div className="dashboard">
            ...
            {stats.upcomingDues.map((book) => (
              <div key={book.id} className={`book-card ${book.urgency}`}>
                ...
                <div className="book-info">
                  ...
                  <button className="btn btn-primary" onClick={() => handleRenewBook(book.id)}>
                    Renew
                  </button>
                </div>
              </div>
      ...
      <div className="dashboard-section">
        ...
        {stats.borrowedBooks.length === 0 ? (
          <p>
            No books currently borrowed. <a href="/search">Search for books</a> to get started!
          </p>
        ) : (
          <div className="books-grid">
